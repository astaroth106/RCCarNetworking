...
ReferenceImages = ["arrowl_final.jpg","arrowstop_final.jpg"]

Symbol_Titles = ["Left Sign","Stop!"] 
...
symbol= [Symbol() for i in range(2)]
...
def readRefImages():
    for count in range(2):
        ...
        symbol[count].name = ReferenceImages[count]
        ...
        for cnt in contours:
                ...
                if len(approx)==4:
                    ...
                    if sign_found == True: 
                        ...
                        sign_found = False                 
                        #w,h = cv2.boundingRect(cnt)
                        perimeter = cv2.arcLength(cnt,True)                 
                        #centroid_x = x + (w/2)                 
                        #centroid_y = y + (h/2) 
                        #print(perimeter)
                        # Real width * focal length = 16175.288                 
                        camera_range = round((16175.288 / perimeter),0) 
                        ...
                        if perimeter > 1420: 
                            if camera_range == 0 or camera_range >= 60:                        
                                ...
                                if perimeter*perimeter >= 70000 and turn == False:                             
